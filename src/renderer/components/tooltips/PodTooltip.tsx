  ...
  render() {
    ...
    return (
      <div className="KubeResourceChartTooltip flex column">
        ...
        <hr />
        <Renderer.Component.DrawerItem name="Namespace">{obj.getNs()}</Renderer.Component.DrawerItem>
        <Renderer.Component.DrawerItem name="Created">{obj.getAge()} ago</Renderer.Component.DrawerItem>
        ...
        <Renderer.Component.DrawerItem name="Node">{obj.getNodeName()}</Renderer.Component.DrawerItem>
        <Renderer.Component.DrawerItem name="Status">
          <span className={Common.Util.cssNames(obj.getStatusMessage().toLowerCase(), "pod-status")}>
